...
function EditForm() {
    ...
    useEffect(() => {
        ...
        const fetchContent = async () => {
            try {
                ...
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/view/${filepath}`);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/file/update`, {
                method: 'POST',
                headers: {
